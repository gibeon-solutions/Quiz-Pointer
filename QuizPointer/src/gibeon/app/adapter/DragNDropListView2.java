...
public class DragNDropListView2 extends ListView {
	...
	public DragNDropListView2(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		switch (action) {
			...
			case MotionEvent.ACTION_MOVE:
				if(y>(getChildAt(0).getHeight()/2)&&y<(getHeight()-(getChildAt(0).getHeight()/2))){
				drag(0,y);// replace 0 with x if desired
				}
				break;
	...
	private void startDrag(int itemIndex, int y) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(getBitmapFromView(item));
